...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_KANGDROID)
extern struct cpufreq_governor cpufreq_gov_kangdroid;
#define CPUFREQ_DEFAULT_GOVERNOR        (&cpufreq_gov_kangdroid)
#endif
